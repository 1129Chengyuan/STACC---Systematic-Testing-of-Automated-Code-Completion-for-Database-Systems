...
class CombinedTests(unittest.TestCase):
    ...
    def setUp(self):
        ...
        blank = []
        import CSVDataTable
        self.managers_table = CSVDataTable.CSVDataTable('data/baseballdatabank-2019.2/core/managers.csv', blank, ['playerID'])
        self.parks_table = CSVDataTable.CSVDataTable('data/baseballdatabank-2019.2/core/Parks.csv', blank, ['park.key'])
        self.teams_table = CSVDataTable.CSVDataTable('data/baseballdatabank-2019.2/core/TeamsFranchises.csv', blank, ['franchID'])
