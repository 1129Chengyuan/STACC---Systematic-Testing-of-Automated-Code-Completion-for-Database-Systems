import unittest
from TestingGenCode import CSVDataTable
from tracemalloc_utils import clear_traces
import sys
sys.path.append("/Users/1129c/Downloads/ChatGPT")
import Consolidated
class CombinedTests(unittest.TestCase):

    def setUp(self):
        clear_traces()
        self.managers_table = CSVDataTable.CSVDataTable('managers.csv', Consolidated.return_gen_code(), ['playerID'])
        self.parks_table = CSVDataTable.CSVDataTable('Parks.csv', Consolidated.return_gen_code(), ['park.key'])
        self.teams_table = CSVDataTable.CSVDataTable('TeamsFranchises.csv', Consolidated.return_gen_code(), ['franchID'])
