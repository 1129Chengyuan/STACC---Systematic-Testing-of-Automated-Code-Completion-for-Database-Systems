...
class CombinedTests(unittest.TestCase):
    ...
    def setUp(self):
        try:
            with open("src/CSVDataTable.py") as f:
        ...
        blank = []
        import CSVDataTable
        self.managers_table = CSVDataTable.CSVDataTable('data/baseballdatabank-2019.2/core/managers', blank, ['playerID'])
        self.parks_table = CSVDataTable.CSVDataTable('data/baseballdatabank-2019.2/core/Parks', blank, ['park.key'])
        self.teams_table = CSVDataTable.CSVDataTable('data/baseballdatabank-2019.2/core/TeamsFranchises', blank, ['franchID'])
