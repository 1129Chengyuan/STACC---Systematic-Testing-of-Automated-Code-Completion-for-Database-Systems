...
class CombinedTests(unittest.TestCase):
    ...
    def setUp(self):
        clear_traces()
        self.managers_table = CSVDataTable('managers.csv', {'filepath': 'managers.csv'}, ['playerID'])
        self.parks_table = CSVDataTable('Parks.csv', {'filename': 'Parks.csv'}, ['park.key'])
        self.teams_table = CSVDataTable('TeamsFranchises.csv', {'filename': 'TeamsFranchises.csv'}, ['franchID'])
